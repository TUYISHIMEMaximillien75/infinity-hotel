          ...
          <div class="col-md-6">
            <h2 class="mb-5">Reservation Form</h2>
                <form action="php/booknow.php" method="post">
                  ...
                  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="names">Both Names</label>
                      <input type="text" id="name" name="b_names" class="form-control ">
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <textarea name="message" id="message" class="form-control" placeholder="Write some note here but it is not very neccesary" cols="30" rows="8"></textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 form-group">
                      <input type="submit" value="Reserve Now" name="reserve" class="btn btn-primary">
                    </div>
                  </div>
                </form>
              </div>
